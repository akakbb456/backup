...
<div class="container" role="main">
    ...
    <div class="bodyFrame">
         메인 화면<br>
      <hr>
      	현재 접속자수: <%= CountManager.getCurrentCount() %> <br>
      	어제 접속자수: <%= CountManager.getyesterDayCount() %> <br>
      	오늘 접속자수: <%= CountManager.getToDayCount() %> <br>
      	전체 접속자수: <%= CountManager.gettotalCount() %> <br>
     </div>
 </div>
